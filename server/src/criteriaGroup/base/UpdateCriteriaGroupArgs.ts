...
@ArgsType()
class UpdateCriteriaGroupArgs {
  @Field(() => CriteriaGroupWhereUniqueInput, { nullable: false })
  where!: CriteriaGroupWhereUniqueInput;
  @Field(() => CriteriaGroupUpdateInput, { nullable: false })
  data!: CriteriaGroupUpdateInput;
}

export { UpdateCriteriaGroupArgs };
